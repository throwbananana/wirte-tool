...
class ProjectTypeManager:
    ...
    TYPES = {
        "General": {
            ...
            "tools": ["outline", "script", "char_events", "story_curve", "tone_outline", "kanban", "calendar", "timeline", "relationship", "wiki", "analytics"],
        ...
        "Suspense": {
            ...
            "tools": ["outline", "script", "char_events", "story_curve", "tone_outline", "evidence_board", "dual_timeline", "kanban", "wiki"],
        ...
        "Romance": {
            ...
            "hint": "推荐人物关系图与情感节奏工具。",
            "tools": ["outline", "script", "char_events", "story_curve", "tone_outline", "relationship", "timeline", "calendar"],
        ...
        "Epic": {
            ...
            "tools": ["outline", "script", "char_events", "story_curve", "tone_outline", "swimlanes", "wiki", "calendar"],
        ...
        "SciFi": {
            ...
            "hint": "推荐势力矩阵与科技设定分类。",
            "tools": ["outline", "script", "char_events", "story_curve", "tone_outline", "kanban", "wiki", "relationship"],
        ...
        "Poetry": {
            ...
            "tools": ["script", "char_events", "story_curve", "tone_outline", "zen_mode"],
            "specialized_modules": ["galgame_assets"],
            "default_tab": "script",
        ...
        "LightNovel": {
            ...
            "hint": "适合插画与人设管理。",
            "tools": ["outline", "script", "char_events", "story_curve", "tone_outline", "wiki", "relationship", "kanban"],
            "specialized_modules": ["galgame_assets"],
            "default_tab": "script",
        ...
        "Galgame": {
            ...
            "tools": ["outline", "script", "char_events", "story_curve", "tone_outline", "relationship", "wiki", "variable", "flowchart"],
            "specialized_modules": ["galgame_assets"],
            "default_tab": "outline",
